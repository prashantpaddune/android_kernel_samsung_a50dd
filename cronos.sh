...
export $CR_ARCH
##########################################
# Device specific Variables [SM-A505F]
CR_CONFG_A505F=exynos9610-a50_defconfig
CR_VARIANT_A505F=A505F
##########################################
...
do
    case $menuvar in
        "SM-A505F")
            clear
            CLEAN_SOURCE
            echo "Starting $CR_VARIANT_A505F kernel build..."
	    CR_VARIANT=$CR_VARIANT_A505F
	    CR_CONFG=$CR_CONFG_A505F
	    BUILD_ZIMAGE
            echo " "
            echo "----------------------------------------------"
